...
public class BookedTicketAdapter extends ArrayAdapter<Payment>  {
    public BookedTicketAdapter(@NonNull Context context, List<Payment> paymentList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        convertView.setOnClickListener(v -> {
            ConfirmWaitingPaymentActivity.waitingPayment = currentNumberPosition;
            ConfirmWaitingPaymentActivity.waitingBus = finalThisScheduleBus;

            Intent intent = new Intent(parent.getContext(), ConfirmWaitingPaymentActivity.class);
